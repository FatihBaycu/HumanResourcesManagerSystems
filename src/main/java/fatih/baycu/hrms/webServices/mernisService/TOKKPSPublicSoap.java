...
public class TOKKPSPublicSoap
{
    ...
    public TOKKPSPublicSoap(){}

    public TOKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TOKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TOKExtendedSoapSerializationEnvelope envelope= new TOKExtendedSoapSerializationEnvelope(TOKExtendedSoapSerializationEnvelope.VER11);
