...
public class TOKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TOKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TOKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TOKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TOKDateTimeConverter dateTimeConverter = new TOKStandardDateTimeConverter();

    public TOKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TOKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TOKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TOKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TOKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TOKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
